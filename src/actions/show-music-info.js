...
let debug = Debug('ShowMusicInfoActions');


class ShowMusicActions {
  /**
    ...
    if (message['@type']) {
      switch (message['@type']) {
        ...
        case 'StatusUpdate':
          ...
          break;
        case 'UpdateAction':
          ShowMusicStore.updateArtist(message.byArtist.name);
          ShowMusicStore.updateAlbum(message.inAlbum.name);
...
export default ShowMusicActions;
